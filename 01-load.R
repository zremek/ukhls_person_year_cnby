...
my_path <- "/Users/remek/Code/ukhls-bhps-career-outline-working-paper/UKDA-6614-spss/spss/spss25/"

# select variables ####

ukhls_variables_to_select <- c(
  "gor_dv", #https://www.understandingsociety.ac.uk/documentation/mainstage/dataset-documentation?search_api_views_fulltext=gor_dv 
  "urban_dv", #UKHLS only! https://www.understandingsociety.ac.uk/documentation/mainstage/dataset-documentation/variable/urban_dv 
  "age_dv", #age in bhps
  "birthy",
  "marstat", # martial status at the time of interview 
  "nnatch", # number of respondents natural children in household at the time of interview
  "istrtdaty",
  "istrtdatm",
  "sex",
  "qfhigh_dv", #https://www.understandingsociety.ac.uk/documentation/mainstage/dataset-documentation/variable/qfhigh_dv 
  "scend", #https://www.understandingsociety.ac.uk/documentation/mainstage/dataset-documentation/variable/scend 
  "jbstat", # full-time student (7), self employed (1), Paid employment(ft/pt) (2)
  "jbhas",
  "jboff",
  "jbsemp", #https://www.understandingsociety.ac.uk/documentation/mainstage/dataset-documentation/variable/jbsemp
  "jbterm1", #https://www.understandingsociety.ac.uk/documentation/mainstage/dataset-documentation/variable/jbterm1 
  "jbterm2", #https://www.understandingsociety.ac.uk/documentation/mainstage/dataset-documentation/variable/jbterm2
  "jbsoc00_cc",
  "jbisco88_cc",
  "jbsect", # is it private sector company https://www.understandingsociety.ac.uk/documentation/mainstage/dataset-documentation/variable/jbsect 
  "jbsectpub", # is it public company 
  "jbsize", #https://www.understandingsociety.ac.uk/documentation/mainstage/dataset-documentation/variable/jbsize 
  "jbft_dv", #https://www.understandingsociety.ac.uk/documentation/mainstage/dataset-documentation/variable/jbft_dv
  "jbhrs", #for employees only https://www.understandingsociety.ac.uk/documentation/mainstage/dataset-documentation/variable/jbhrs 
  "jlisco88_cc", # of last job! - asked if (Did no paid work in last week and does not have a job) JBHAS = 2 AND JBOFF = 2
  "jlsemp", #https://www.understandingsociety.ac.uk/documentation/mainstage/dataset-documentation/variable/jlsemp
  "jbhad",
  "jbbgm",
  "jbbgy",
  "jbnssec8_dv",
...
ukhls_wave_2_onwards_select <- c(
  ...
  "nqfhigh_dv" #https://www.understandingsociety.ac.uk/documentation/mainstage/dataset-documentation/variable/nqfhigh_dv
) # vars regarding end of job / other status end date - to do

# read indresp data ####

# read wave 1 UKHLS
longfile <- haven::read_spss(file = paste0(my_path, "ukhls_w1/a_indresp.sav")) %>%
  select(all_of(paste0("a_",
                       c(ukhls_variables_to_select, nsssec_to_select), 
                       sep = "")),
         pidp) %>%
...
for (wave_number in 2:10) {
  wave_letter <- paste0(letters[wave_number],"_")
  wave_data <- read_spss(paste0(my_path, "ukhls_w",
                                wave_number, "/", wave_letter,
                                "indresp.sav")) %>%
    select(all_of(paste(wave_letter, c(ukhls_variables_to_select,
                                       nsssec_to_select,
                                       ukhls_wave_2_onwards_select), sep = "")),
           pidp) %>% 
